...
export function ProjectCard({ name, description, tag }: ProjectCardProps) {
  return (
    <div className="group h-full rounded-2xl border border-slate-200/80 bg-white/90 backdrop-blur-sm p-8 shadow-lg shadow-slate-200/30 transition-all duration-300 hover:shadow-xl hover:shadow-teal-100/40 hover:border-teal-200/80 hover:-translate-y-2 hover:scale-[1.02]">
