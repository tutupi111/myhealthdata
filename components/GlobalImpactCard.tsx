...
export function GlobalImpactCard({ value, label }: GlobalImpactCardProps) {
  return (
    <div className="group relative rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-8 transition-all duration-300 hover:bg-white/10 hover:border-teal-400/30 hover:-translate-y-1">
